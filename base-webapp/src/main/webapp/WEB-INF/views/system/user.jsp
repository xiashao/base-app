                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="javascript:;" class="btn default yellow-stripe" id="addUser"><i
...
<script type="text/javascript" src="<c:url value="/js/system/user.js"/> "></script>
<script id="actionBtn" type="text/html">
    <a class="edit btn default btn-xs purple btn-outline" userId="{{full.id}}"><i class="fa fa-edit"></i> 编辑</a>
